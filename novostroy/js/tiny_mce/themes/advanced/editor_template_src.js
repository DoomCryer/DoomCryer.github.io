	...
	tinymce.create('tinymce.themes.AdvancedTheme', {
		...
		init : function(ed, url) {
			...
			t.settings = s = extend({
				...
				theme_advanced_fonts : "Mistral=mistral;LaRus=la_rus;Banco=banco;BIP=bip;Bosanova=bosanova;Caberne=caberne;Capitalist=capitalist;Chibola=chibola;Hatten=hatten;Molot=molot;Corsva=corsva;Simple=simple;Times=times;Tomato=tomato;Wien=wien;Westerlandc=westerlandc;Rosa=rosa;Pilotka=pilotka;Ply=ply;Segoesc=segoesc;Jacob=jacob;Country=country;Derby=derby;Dolores=dolores;Greece=greece;Moster=moster;Europe=europe;Gothic=gothic;Gildia=gildia;Gildia_b=gildia_bold;Bankir=bankirretro;Campus=camp;Decree=decree;Traktir=traktir;Egipet=egipet;Andale Mono=andale mono,times;Arial=arial,helvetica,sans-serif;Arial Black=arial black,avant garde;Book Antiqua=book antiqua,palatino;Comic Sans MS=comic sans ms,sans-serif;Courier New=courier new,courier;Georgia=georgia,palatino;Helvetica=helvetica;Impact=impact,chicago;Symbol=symbol;Tahoma=tahoma,arial,helvetica,sans-serif;Terminal=terminal,monaco;Times New Roman=times new roman,times;Trebuchet MS=trebuchet ms,geneva;Verdana=verdana,geneva;Webdings=webdings;Wingdings=wingdings,zapf dingbats",
