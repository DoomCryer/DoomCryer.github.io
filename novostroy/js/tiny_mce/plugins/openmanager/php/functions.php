<?php
	...
	function get_html($pconfig, $ext = "")
	{
		...
		if($currentPage > 1)
		{
			if($totPages>1)
			{
				$links_html .= "<li id=\"gliFirst\"><a data-target-page=\"1\" href=\"#\">&lt; Первая</a></li>";
			}
			$links_html .= "<li id=\"gliPrev\"><a data-target-page=\"prev\" href=\"#\">Пред</a></li>";
		}
		else
		{
			if($totPages>1)
			{
				$links_html .= "<li class=\"disabled\" id=\"gliFirst\"><a data-target-page=\"1\" href=\"#\">&lt; Первая</a></li>";
			}
			$links_html .= "<li class=\"disabled\" id=\"gliPrev\"><a data-target-page=\"prev\" href=\"#\">Пред</a></li>";
		}
		...
		if($currentPage < $roundPages)
		{
			...
			$links_html .= "<li id=\"gliNext\"><a href=\"#\" data-target-page=\"next\">След</a></li>";
			
			if($totPages>1)
			{
				$links_html .= "<li id=\"gliLast\"><a href=\"#\" data-target-page=\"$roundPages\">Последняя &gt;</a></li>";
			}
		}
		else
		{
			$links_html .= "<li id=\"gliNext\" class=\"disabled\"><a href=\"#\" data-target-page=\"next\">След</a></li>";
			
			if($totPages>1)
			{
				$links_html .= "<li id=\"gliLast\" class=\"disabled\"><a href=\"#\" data-target-page=\"$roundPages\">Последняя &gt;</a><li>";
			}
		}
		if($roundPages>9)
		{
